                ...
                <div class="span12">
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Edit Events</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                             <?php
                              $id = $_GET['id'];
                              $query = mysqli_query($connect, "select * from events where id='$id'") or die(mysqli_error());
                              
                              $data = mysqli_fetch_array($query);
                              ?>
                            <form name="tambah_event" action="../aksi_admin/aksi_edit_events.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                               <input type="hidden" name="id" value="<?php echo $id; ?>" />
                                <div class="control-group">
                                    <label class="control-label">Judul</label>
                                    <div class="controls">
                                        <input type="text" value="<?php echo $data['title'] ?>" class="input-xlarge"  name="judul" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Start</label>
                                    <div class="controls">
                                        <input type="text" value="<?php echo $data['start'] ?>" class="input-large"  name="start" id="datestart" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">End</label>
                                    <div class="controls">
                                        <input type="text" value="<?php echo $data['end'] ?>"class="input-large"  name="end" id="dateend" />
                                    </div>
                                </div>
