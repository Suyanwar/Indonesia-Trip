                ...
                <div class="span12">
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Tambah Article</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <form name="tambah_article" action="../aksi_admin/aksi_tambah_article.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="input-large m-wrap" tabindex="1" name="lokasi" >
                                            <?php
                                                $query = mysqli_query($connect, "SELECT * FROM lokasi_kategori order by lokasi asc");
                                                 $no = 1;
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="Masukan Koordinat Lokasi" class="input-xlarge"  name="koordinat" />
                                    </div>
                                </div>
                                <div class="control-group">
