...
<html>
  ...
  <body>
   <header>
    ...
    </div>><!-- e/o section1 --><!-- e/o section2 --><!-- e/o section3 --><!-- eo section 5 -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="secHeader">
              ...
              <h1 class="text-center">TIPS AND TRICK - PERJALANAN</h1>
            ...
            <br><br><br>
                ...
                <div class="row">
             <?php
                    $query = mysqli_query($connect, "SELECT * FROM tips where kategori = 'Perjalanan'");
                    $no = 1;
